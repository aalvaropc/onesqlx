defmodule OnesqlxWeb.UserAuth do
  ...
  @remember_me_cookie "_onesqlx_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      OnesqlxWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      OnesqlxWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule OnesqlxWeb.PageLive do
        use OnesqlxWeb, :live_view

        on_mount {OnesqlxWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{OnesqlxWeb.UserAuth, :require_authenticated}] do
  ...
  def signed_in_path(_), do: ~p"/dashboards"
